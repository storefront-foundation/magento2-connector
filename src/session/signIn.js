...
export default async function signIn(req, res) {
  try {
    ...
    res.cookie(COOKIES.M2_CUSTOMER_TOKEN, token, { maxAge: 1000 * 3600 * 24 * 30 }) // set customer token cookie for 30 days
    res.cookie(COOKIES.M2_CUSTOMER_CART_ID, customerCartId, { maxAge: 1000 * 3600 * 24 * 30 }) // set customer cart ID cookie for 30 days
